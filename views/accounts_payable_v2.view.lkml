view: accounts_payable_v2 {
  ...
  measure:  sum_past_overdue_1_to_30days_conv_drill{
    ...
    link: {
      ...
      url: "/dashboards/cortex_sap_operational_arauco_qa::sap_finance_ap_07_a_accounts_payable_aging?Target+Currency={{ _filters['accounts_payable_v2.target_currency_tcurr']| url_encode }}&Vendor+Name={{ _filters['accounts_payable_v2.name1']| url_encode }}&Company+Name={{ _filters['accounts_payable_v2.company_text_butxt']| url_encode }}"
    }
  }
