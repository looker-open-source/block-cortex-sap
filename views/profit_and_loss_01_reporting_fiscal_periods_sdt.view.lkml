...
#
#                            If multiple timeframes selected and Aggregate = 'No', each set comparisons will be given a unique group number
...
#
#        selected_timeframe -- returns values for either fiscal_year, fiscal_year_quarter or fiscal_year_period based on parameter_display_time_dimension
