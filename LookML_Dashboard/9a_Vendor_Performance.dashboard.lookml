- dashboard: delivery_performance_trend
  title: "[SAP VENDOR PERFORMANCE] 09a: Delivery Performance Trend"
  layout: newspaper
  ...
  - title: Delivery Performance Detailed Report
    ...
    fields: [vendor_performance.company_text_butxt, vendor_performance.purchasing_organization_text_ekotx,
      vendor_performance.purchasing_group_text_eknam, vendor_performance.vendor_account_number_lifnr,
      vendor_performance.name1, vendor_performance.country_key_land1, vendor_performance.document_number_ebeln,
      vendor_performance.item_ebelp, materials_md.material_text_maktx, vendor_performance.purchasing_document_date_bedat_date,
      ...
      material_types_md.description_of_material_type_mtbez, vendor_performance.is_delivered,
      vendor_performance.is_rejected]
    filters:
    ...
    column_order: ["$$$_row_numbers_$$$", vendor_performance.company_text_butxt, vendor_performance.purchasing_organization_text_ekotx,
      ...
      vendor_performance.purchasing_document_date_bedat_date, vendor_performance.Schedule_line_date_date,
      vendor_performance.Requested_delivery_date_date, vendor_performance.Actual_Receipt_Date_date,
      vendor_performance.item_delivery_date_eindt_date, vendor_performance.Invoice_date_date,
      vendor_performance.poquantity_menge, vendor_performance.uo_m_meins, vendor_performance.goods_receipt_quantity,
      vendor_performance.uo_m_meins2, vendor_performance.invoice_quantity, vendor_performance.uo_m_meins3,
      vendor_performance.On_Time, vendor_performance.In_full, vendor_performance.is_rejected,
      vendor_performance.is_delivered]
    show_totals: true
    ...
    series_labels:
      ...
      vendor_performance.Actual_Receipt_Date_date: Actual Receipt Date
      ...
      vendor_performance.On_Time: On-time
      ...
      vendor_performance.In_full: In-full
