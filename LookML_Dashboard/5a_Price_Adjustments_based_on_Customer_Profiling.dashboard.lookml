- dashboard: price_adjustments_based_on_customer_profiling
  ...
  - title: Price Adjustments based on Customer Profiling
    ...
    type: looker_grid
    fields: [data_intelligence_otc.Sold_To_Party, data_intelligence_otc.sales_order,
      data_intelligence_otc.sales_order_line_item, data_intelligence_otc.sales_order_qty,
      data_intelligence_otc.sales_order_net_value_Global_Currency, data_intelligence_otc.product,
      data_intelligence_otc.list_price_Global_currency, data_intelligence_otc.adjusted_price_Global_currency,
      data_intelligence_otc.variation_of_listprice_and_adjustedprice]
    filters: {}
    sorts: [data_intelligence_otc.Sold_To_Party]
    limit: 5000
    ...
    series_text_format:
      ...
      data_intelligence_otc.variation_of_listprice_and_adjustedprice:
        align: right
      data_intelligence_otc.adjusted_price_Global_currency:
        align: right
